...
export type OrganizationPatch401Response = PathResponse<typeof path, "patch", 401>;
export type OrganizationPatch403Response = PathResponse<typeof path, "patch", 403>;
